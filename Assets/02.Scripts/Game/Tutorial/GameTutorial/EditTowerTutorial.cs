...
public class EditTowerTutorial : TutorialBase
{
    ...
    {
        // 설치된 타워 위치 아무거나
        Vector3 startPos = BuildingSystem.Instance.CellToWorldPos(BuildingSystem.Instance.GridObjectMap.Keys.First());
        ...
        controller.Dialogue.EnQueueText("잘하셨어요! 타워는 최대 2개까지 설치가 됩니다.");
